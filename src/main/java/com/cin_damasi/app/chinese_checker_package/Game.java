...
import static com.cin_damasi.app.chinese_checker_package.ProjectDefinitions.*;
...
public class Game implements PieceListener, SquareListener, Runnable {
    ...
    public void pieceClicked(Piece piece) {
        ...
        if (this.currentPlayer instanceof HumanPlayer && piece.getColor() == currentPlayer.whichPlayer) {
